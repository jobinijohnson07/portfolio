    ...
    <div className="about-section bg-white dark:bg-black text-black dark:text-white">
      <div className="display-section">
        ...
        <div className="content-section">
          <h2 className="aboutheading-content text-neutral-700 dark:text-neutral-400">
            About Me
          </h2>
          <p className="about-content max-w-xl text-sm md:text-lg text-neutral-700 dark:text-neutral-400">
